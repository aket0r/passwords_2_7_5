...
> Команды в боте: /settings, /logs, /user, /passwords

> /settings - Показывает настройки аккаунта

> /logs - отправляет файл с логами

> /user - отображает данные аккаунта

> /passwords - отправляет файл паролей
